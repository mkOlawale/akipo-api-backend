       ...
       <div class="content">
			<div class="container-fluid">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					...
					<div class="_input_field">
						<Select  filterable multiple placeholder="Select tag" v-model="data.tags_id">
					...
					<div class="_input_field">
					 ...
					 <div class="_input_field">
						...
						<!-- <div class="_input_field">
						 <Button @click="save" :loading="isCreating" :disabled="isCreating">Test vue editor js: v:1.1.1</Button>
					 </div> -->
			</div>
		</div>
    </div>
...
export default {
	...
	methods : {
        async onSave(response){
            ...
            if(!this.data.tags_id.length) return this.e('Tag is required')
