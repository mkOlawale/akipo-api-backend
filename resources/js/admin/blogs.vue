					...
					<div class="_overflow _table_div">
						<table class="_table">
							...
							<tr v-for="(blog, i) in blogs" :key="i" v-if="blogs.length">
								...
								<!-- ITEMS -->
								<page :total="pageInfo.total" :current="pageInfo.current_page" :page-size="parseInt(pageInfo.per_page)" @on-change="blogpageinfo" v-if="pageInfo"></page>
					</table>
					</div>
				</div>
